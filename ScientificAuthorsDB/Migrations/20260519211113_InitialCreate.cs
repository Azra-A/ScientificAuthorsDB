    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Доминиращите модели за преобразуване на последователности се основават на сложни рекурентни или конволюционни невронни мрежи. Ние предлагаме нова проста мрежова архитектура, наречена Transformer (Трансформатор), базирана изцяло на механизми за внимание, като напълно премахва необходимостта от рекурентност и конволюции.", "10.48550/arXiv.1706.03762", null, "Advances in Neural Information Processing Systems (NIPS)", "Доклад от конференция", "Вниманието е всичко, от което имате нужда", 2017 },
                    { 2, "Ние систематично анализираме скорошни публикации по софтуерно инженерство, за да изследваме наличието, местоположението, форматите и дълготрайността на споделените артефакти. Нашите открития предоставят изчерпателен преглед на текущите практики и насоки за бъдещи възпроизводими изследвания.", "10.1016/j.jss.2024.112032", null, "Journal of Systems and Software", "Научна статия", "Изследователски артефакти в публикациите по софтуерно инженерство: Състояние и тенденции", 2024 },
                    { 3, "Дори лошият код може да функционира. Но ако кодът не е чист, той може да срине една организация за разработка. Тази книга ви учи как да пишете чист, лесен за поддръжка и четим код, превръщайки ви в истински софтуерен майстор.", "9780132350884", null, "Prentice Hall", "Книга", "Чист код: Наръчник за гъвкаво софтуерно майсторство", 2008 },
                    { 101, "Изследване на приложението на невронни мрежи за ранна диагностика.", "10.1038/s41586-022-00001", null, "Nature", "Научна статия", "Машинно обучение в здравеопазването", 2022 },
                    { 102, "Анализ на новите методи за стабилизиране на кубити.", "10.1126/science.abn0002", null, "Science", "Научна статия", "Напредък в квантовите изчисления", 2023 },
                    { 103, null, "10.1016/j.ecotod.2021.0003", null, "Списание „Икономическа мисъл“", "Доклад от конференция", "Изкуствен интелект във финансите", 2021 },
                    { 104, "Картографиране на генома при редки заболявания.", "10.1016/j.cell.2020.0004", null, "Cell", "Научна статия", "Генетика и наследствени заболявания", 2020 },
                    { 105, null, "10.5555/nano-book-2023", null, "Академично издателство „Проф. Марин Дринов“", "Монография", "Нови материали в нанотехнологиите", 2023 }
                });

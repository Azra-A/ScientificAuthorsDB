    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Publication>().HasData(
                new Publication { Id = 1, Title = "Вниманието е всичко, от което имате нужда", Year = 2017, Journal = "31-ва Конференция по системи за обработка на невронна информация (NIPS)", PublicationType = "Доклад от конференция", Doi = "10.48550/arXiv.1706.03762", Abstract = "Доминиращите модели за преобразуване на последователности се основават на сложни рекурентни или конволюционни невронни мрежи. Ние предлагаме нова проста мрежова архитектура, наречена Transformer (Трансформатор), базирана изцяло на механизми за внимание, като напълно премахва необходимостта от рекурентност и конволюции." },
                new Publication { Id = 2, Title = "Изследователски артефакти в публикациите по софтуерно инженерство: Състояние и тенденции", Year = 2024, Journal = "Журнал за системи и софтуер", PublicationType = "Научна статия", Doi = "10.1016/j.jss.2024.112032", Abstract = "Ние систематично анализираме скорошни публикации по софтуерно инженерство, за да изследваме наличието, местоположението, форматите и дълготрайността на споделените артефакти. Нашите открития предоставят изчерпателен преглед на текущите практики и насоки за бъдещи възпроизводими изследвания." },
                new Publication { Id = 3, Title = "Чист код: Наръчник за гъвкаво софтуерно майсторство", Year = 2008, Journal = "Издателство Prentice Hall", PublicationType = "Книга", Doi = "9780132350884", Abstract = "Дори лошият код може да функционира. Но ако кодът не е чист, той може да срине една организация за разработка. Тази книга ви учи как да пишете чист, лесен за поддръжка и четим код, превръщайки ви в истински софтуерен майстор." },

                new Publication { Id = 101, Title = "Машинно обучение в здравеопазването", Year = 2022, Journal = "Природа", PublicationType = "Научна статия", Doi = "10.1038/s41586-022-00001", Abstract = "Изследване на приложението на невронни мрежи за ранна диагностика." },
                new Publication { Id = 102, Title = "Напредък в квантовите изчисления", Year = 2023, Journal = "Наука", PublicationType = "Научна статия", Doi = "10.1126/science.abn0002", Abstract = "Анализ на новите методи за стабилизиране на кубити." },
                new Publication { Id = 103, Title = "Изкуствен интелект във финансите", Year = 2021, Journal = "Икономика днес", PublicationType = "Доклад от конференция", Doi = "10.1016/j.ecotod.2021.0003" },
                new Publication { Id = 104, Title = "Генетика и наследствени заболявания", Year = 2020, Journal = "Клетка", PublicationType = "Научна статия", Doi = "10.1016/j.cell.2020.0004", Abstract = "Картографиране на генома при редки заболявания." },
                new Publication { Id = 105, Title = "Нови материали в нанотехнологиите", Year = 2023, Journal = "Издателство 'Наука'", PublicationType = "Монография", Doi = "10.5555/nano-book-2023" }
            );
